...
#define __JPEGDEC__
	...
	defined(ESP_PLATFORM) || defined(_WIN64) || defined(PICO_PLATFORM)
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
...
// Cortex-M4/M7 allow unaligned access to SRAM
	...
	defined(__x86_64__) || defined(TEENSYDUINO)
...
typedef struct jpeg_image_tag {
	...
	int16_t sUnalignedMCUs
		[8 +
		 (DCTSIZE * MAX_MCU_COUNT)]; // 4:2:0 needs 6 DCT blocks per MCU
	void *pFramebuffer;
